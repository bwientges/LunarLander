import Memory, Agent, Environment, DDQN_Model, Result 
...
def main():
    ...
    model = DDQN_Model.Model()
    results = Result.Result()

    target_network = model.create_neural_network()
    ...
    for episode in range(model.no_episodes):
        ...
        while not environment.terminated:
            ...
            state = next_state            
            model.update(target_network, eval_network, memory)
